...
curl -fL "$BASE/osrs-wiki-cache-utils-v0.3.0-aarch64-apple-darwin" -o osrs-wiki-cache-utils
...
mkdir -p "$HOME/Documents/osrs" && cd "$HOME/Documents/osrs"
BASE=https://github.com/m8aq/osrs-wiki-cache-utils/releases/latest/download
curl -fL "$BASE/osrs-wiki-cache-utils-v0.3.0-x86_64-unknown-linux-musl" -o osrs-wiki-cache-utils
curl -fLO "$BASE/wiki.sqlite"
chmod +x osrs-wiki-cache-utils
```
...
$base = "https://github.com/m8aq/osrs-wiki-cache-utils/releases/latest/download"
Invoke-WebRequest "$base/osrs-wiki-cache-utils-v0.3.0-x86_64-pc-windows-msvc.exe" -OutFile osrs-wiki-cache-utils.exe
